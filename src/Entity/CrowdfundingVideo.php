...
use c975L\ShopBundle\Repositiry\CrowdfundingVideoRepository;
use Symfony\Component\HttpFoundation\File\File;
use Vich\UploaderBundle\Mapping\Annotation as Vich;

#[ORM\Entity(repositoryClass: CrowdfundingVideoRepository::class)]
#[ORM\Table(name: 'shop_crowdfunding_video')]
#[Vich\Uploadable]
class CrowdfundingVideo
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
