...
class ProductItemsBlockType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            // Left empty on a product sheet, the block sells the product that sheet is about - which is what placing it there is for; a slug is only needed to sell a product from somewhere else
