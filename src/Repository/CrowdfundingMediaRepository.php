...
/**
 * @extends ServiceEntityRepository<CrowdfundingMedia>
 */
class CrowdfundingMediaRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, CrowdfundingMedia::class);
    }
